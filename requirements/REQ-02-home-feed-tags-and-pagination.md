...
| ID | Question | Why |
|---|---|---|
| REQ-02.I1 | Which tags count as "Popular", and in what order? The sidebar showed 50 tags, while `GET /api/tags` returned 3 400 tags with no ordering. | The UI selection rule is not visible in the backend — *implicit — confirm* |
