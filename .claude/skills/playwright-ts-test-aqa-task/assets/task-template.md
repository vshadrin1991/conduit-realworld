...
- [ ] All cases from **Test cases** with status _Confirmed_ are automated
...
_UI and hybrid tasks only — remove this section for an API-only task._
...
- <Rule or exact message> — _source_

### API contract

_API and hybrid tasks only — remove this section for a UI-only task._
